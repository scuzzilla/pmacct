...
struct bgp_misc_structs {
  ...
  u_int32_t (*route_info_modulo)(struct bgp_peer *, struct bgp_info *, path_id_t *, int);
...
extern u_int32_t (*bgp_route_info_modulo)(struct bgp_peer *, struct bgp_info *, path_id_t *, int);
