...
void NF_mpls_label_stack(struct channels_list_entry *chptr, struct packet_ptrs *pptrs, char **data)
{
  ...
  static unsigned long int labels_cicle[6] = {0};
  ...
  case 9:
    ...
    */
    ...
    printf("array_mpls_top_label_stack_section: %lu\n", labels_cicle[0]);
    labels_cicle[1] = pmpls->mpls_label_stack_section2;
    printf("array_mpls_label_stack_section2: %lu\n", labels_cicle[1]);
