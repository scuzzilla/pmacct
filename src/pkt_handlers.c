...
void NF_mpls_label_stack(struct channels_list_entry *chptr, struct packet_ptrs *pptrs, char **data)
{
  ...
  case 9:
    ...
    pmpls->mpls_label_stack = (char *) malloc(sizeof(char) * (strlen(label_buf) + 4));
    ...
    for(idx_0 = 1; idx_0 < 6; idx_0++) {
      ...
      pmpls->mpls_label_stack = (char *) realloc(pmpls->mpls_label_stack, sizeof(char) * (strlen(label_buf) + 4));
